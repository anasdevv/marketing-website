...
export default ({
  ...
  heading = (
    <>
      Our Expertise
      <span tw='text-primary-500'>Crafting Excellence for Your Vehicle.</span>
    </>
  ),
  description = `At SparkShine, we believe in delivering more than just a clean car. Our detailing professionals are dedicated to precision, perfection, and enhancing your vehicle's overall aesthetic and performance.`,
          ...
          <TextContent>
            <Heading>
              ...
              <span tw='pl-2 text-blue-600'>
                Crafting Excellence for Your Vehicle.
              </span>
            </Heading>
